...
def create_motion_control_sliders(
    ...
    *,
    ...
    loop: bool = True,
    frame_update_callback: Callable[[int, int, float], None] | None = None,
    ...
    def _apply_discrete_frame(i: int) -> None:
        ...
        if frame_update_callback is not None:
            frame_update_callback(i, i, 0.0)
