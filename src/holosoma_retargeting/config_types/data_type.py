...
# SMPL-H 22-joint body subset (legacy)
SMPLH22_DEMO_JOINTS = [
    "Pelvis",
    "L_Hip",
    "R_Hip",
...
# SMPL-H subset used by mappings (order preserves SMPLH_DEMO_JOINTS)
SMPLH_MAPPED_DEMO_JOINTS = [
    "Pelvis",
    "L_Hip",
    "L_Knee",
    "L_Ankle",
...
# HumanML3D (MotionGPT) 22-joint format (T2M order)
HUMANML3D_DEMO_JOINTS = [
    "pelvis",
    "left_hip",
    "right_hip",
    "spine1",
...
TOE_NAMES_BY_FORMAT = {
    ...
    "smplx": ["L_Foot", "R_Foot"],
    "smplh22": ["L_Foot", "R_Foot"],
    "smplh_mapped": ["L_Toe", "R_Toe"],
    "humanml3d": ["left_foot", "right_foot"],
}
...
DEMO_JOINTS_REGISTRY: dict[str, list[str]] = {
    ...
    "smplh22": SMPLH22_DEMO_JOINTS,
    "smplh_mapped": SMPLH_MAPPED_DEMO_JOINTS,
    "humanml3d": HUMANML3D_DEMO_JOINTS,
}
